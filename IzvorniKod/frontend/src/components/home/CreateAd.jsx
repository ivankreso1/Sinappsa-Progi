...
import { getCategoriesPretty, getCategoryToEnumValue, getData, getPersonInfo, postDataAuth } from "../../scripts/util";
					...
					<Form className="form" onSubmit={optionSubmitForm}>
						...
						<div className="mb-3">
							<Form.Select
								...
								onChange={handleAdChange}
							>
								<option key="createAddAllCourses" value="">Kolegij</option>
						...
						<div className="mb-3">
							<Form.Select
								...
								onChange={handleAdChange}
							>
								<option key="createAddAllCategories" value="">Kategorija</option>
								{kategorije.map((kategorija) => {
									return (
										<option key={`createAdd${kategorija}category`} value={getCategoryToEnumValue(kategorija)}>
											{kategorija}
										</option>
									);
								})}
